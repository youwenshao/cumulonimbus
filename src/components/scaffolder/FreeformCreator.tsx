  ...
  return (
    <div className={cn('space-y-6', className)}>
      ...
      <div className="text-center">
        ...
        <h2 className="text-2xl font-bold mb-2">Create Your App</h2>
        ...
        <>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-32 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 resize-none"
                  />
                </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm text-gray-400">Need inspiration? Try one of these:</span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
              {EXAMPLE_PROMPTS.map((example, i) => (
                ...
                >
                  <ChevronRight className="w-4 h-4 inline mr-2 text-red-500" />
                  {example}
                </button>
              ))}
            </div>
          ...
          <Card variant="outlined" padding="lg">
            ...
            {design && (
              <div className="mt-4 p-4 bg-gray-800/50 rounded-lg">
                <h3 className="font-semibold mb-2">{design.appName}</h3>
        ...
        <div className="space-y-6">
          <Card variant="outlined" padding="lg">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="font-semibold text-lg">{design?.appName || 'Your App'}</h3>
